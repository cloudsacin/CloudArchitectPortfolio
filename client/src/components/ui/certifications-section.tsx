      ...
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-primary mb-4">Certifications & Credentials</h2>
            <div className="w-24 h-1 bg-accent mx-auto mb-6"></div>
          </div>
          
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {certifications.map((cert, index) => (
              <Card key={index} className={`${cert.gradient} border hover:shadow-lg transition-shadow`}>
                <CardContent className="p-6">
                  <div className="flex items-start mb-4">
                    <i className={`${cert.icon} text-2xl ${cert.iconColor} mr-3 mt-1`}></i>
                    <div className="flex-1">
                      <h3 className="font-semibold text-primary text-lg leading-tight">{cert.title}</h3>
                  ...
                  <p className="text-sm text-gray-500 mb-4">{cert.validity}</p>
                  <a 
          ...
          <div className="text-center mt-12">
            <div className="bg-surface-custom rounded-lg p-6 mb-6">
              <p className="text-gray-700 text-lg mb-4 font-medium">
                Total Certifications: 7x Azure | 2x AWS | 1x GCP | Multiple Specialized Certifications
              </p>
              <a 
                href="https://linkedin.com/in/sachinjha" 
                target="_blank" 
